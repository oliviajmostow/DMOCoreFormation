...
def load_my_custom_color_tables():
    fna='heat_red'
    cdict_tmp={\
    'red':   ((0., 0.0416, 0.0416),(0.365079, 1.000000, 1.000000),(1.0, 1.000000, 1.000000)),\
    'green': ((0.,     0., 0.0   ),(0.71    , 0.000000, 0.000000),(1.0, 1.000000, 1.000000),(1.0, 1.0, 1.0)),\
    'blue':  ((0.,     0., 0.0   ),(0.71    , 0.000000, 0.000000),(1.0, 1.000000, 1.000000))}
    my_cmap = matplotlib.colors.LinearSegmentedColormap(fna,cdict_tmp,256);
    matplotlib.cm.register_cmap(name=fna,cmap=my_cmap, override_builtin=True);
#    matplotlib.colormaps[fna] = my_cmap
